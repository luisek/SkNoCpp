...
std::unique_ptr<Concrete> constructArgs(Ts &&...args) {
  if constexpr (std::is_constructible_v<
                    Concrete, Ts...>) // bez constexpr kod sie nie kompiluje
                                      // jesli chcemy zapewnic wylaczenie galezi
                                      // i pozwolic na dzialanie
...
class Test {
public:
  Test(int, int) { std::cout << __PRETTY_FUNCTION__ << std::endl; }
